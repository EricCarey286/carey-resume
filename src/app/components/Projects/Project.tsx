...
export default function Project(){
  return (
      <div className='project-container'>
        ...
        <a className='project-preview' target="_blank" rel="noopener noreferrer" href='https://www.bannedbookshub.com'><Image className='preview-img' id="bbh-preview" src={bbhPreview} alt="Banned Books Hub Preview" width={600} height={338}/></a>
      </div>
  );
}